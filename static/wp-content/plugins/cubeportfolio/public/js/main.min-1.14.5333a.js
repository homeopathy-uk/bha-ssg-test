...
// calculate numbers of cols
b.cols=b[a.isArray(b.options.mediaQueries)?"getColumnsBreakpoints":"getColumnsAuto"](),b.columnWidth=b.columnWidthTruncate((b.width+b.options.gapVertical)/b.cols),b.widthAvailable=b.columnWidth*b.cols,"mosaic"===b.options.layoutMode&&b.getMosaicWidthReference(),b.options.coverRatio!==d){b.blocks.each(function(c,d){var// layoutMode === grid || slider
e,f=a(d).data("cbp"),g=1;"mosaic"===b.options.layoutMode&&(g=b.getColsMosaic(f.widthInitial)),e=b.columnWidth*g-b.options.gapVertical,d.style.width=e+"px",f.width=e,f.widthAndGap=e+b.options.gapVertical,d.style.height=""});var c=[];b.blocks.each(function(b,d){var e=a(d),f=e.data("cbp").width;a.each(e.find("img").filter("[width][height]"),function(a,b){var d=f/parseInt(b.getAttribute("width"),10);c.push({el:b,width:f,height:Math.floor(parseInt(b.getAttribute("height"),10)*d)})})}),a.each(c,function(a,b){b.el.width=b.width,b.el.height=b.height,b.el.style.width=b.width+"px",b.el.style.height=b.height+"px"}),b.blocks.each(function(c,d){var e=a(d).data("cbp"),f=d.getBoundingClientRect(),g=Math.round(f.bottom-f.top);e.height=g,e.heightAndGap=g+b.options.gapHorizontal})}else{var e=b.columnWidth-b.options.gapVertical;b.blocks.each(function(c,d){var f=a(d).data("cbp"),g=parseInt(f.heightInitial*(e/f.widthInitial),10);
// set new css for current element
d.style.width=e+"px",d.style.height=g+"px",f.width=e,f.widthAndGap=e+b.options.gapVertical,f.height=g,f.heightAndGap=g+b.options.gapHorizontal})}}}(jQuery,window,document),
// ResetCaption
function(a,b,c,d){"use strict";function e(b){var c=this;c.parent=b,b.registerEvent("initStartWrite",function(){if(b.options.coverRatio!==d){b.$obj.addClass("cbp-reset-caption");var c,e,f,g=b.options.coverRatio.split(":");2===g.length&&(b.$obj.addClass("cbp-ratio-even"),c=parseInt(g[0],10),e=parseInt(g[1],10),f=e/c*100+"%"),b.blocks.each(function(b,d){var h=a(d),i=f,j=h.attr("data-cbp-coverRatio"),k=h.find(".cbp-caption");j&&("0:0"!==j?(g=j.split(":"),c=parseInt(g[0],10),e=parseInt(g[1],10),i=e/c*100+"%"):i=""),k.length&&(k[0].style.paddingTop=i)})}}),b.registerEvent("addItemsToDOM",function(c){if(b.options.coverRatio!==d){var e,f,g,h=b.options.coverRatio.split(":");2===h.length&&(e=parseInt(h[0],10),f=parseInt(h[1],10),g=f/e*100+"%"),a.each(c,function(b,c){var d=g,i=a(c),j=i.attr("data-cbp-coverRatio"),k=i.find(".cbp-caption");j&&("0:0"!==j?(h=j.split(":"),e=parseInt(h[0],10),f=parseInt(h[1],10),d=f/e*100+"%"):d=""),k.length&&(k[0].style.paddingTop=d)})}})}var f=a.fn.cubeportfolio.constructor;a.fn.cubeportfolio.options.coverRatio=d,e.prototype.destroy=function(){this.parent.$obj.removeClass("cbp-reset-caption cbp-ratio-even"),this.parent.$obj.find(".cbp-caption").css("paddingTop","")},f.plugins.resetCaption=function(a){return new e(a)}}(jQuery,window,document),
// CorrectIdFrontend
function(a,b,c,d){"use strict";function e(a){var b=this;b.parent=a,b.attrId=a.$obj.attr("id"),b.attrId&&(b.id=parseInt(b.attrId.replace("cbpw-grid",""),10),a.$obj.attr("id",""),a.wrapper.attr("id",b.attrId),a.registerEvent("initStartWrite",function(c){
// add id attr to singlePage block
a.singlePage&&a.singlePage.wrap.attr("id","cbpw-singlePage"+b.id)}))}var f=a.fn.cubeportfolio.constructor;e.prototype.destroy=function(){var a=this;a.parent.$obj.attr("id",a.attrId)},f.plugins.correctIdFrontend=function(a){
// if is frontend run this plugin
// if is frontend run this plugin
return"undefined"==typeof cbpwOptions?new e(a):void 0}}(jQuery,window,document),
// refresh drag layout
function(a,b,c,d){"use strict";var e=a.fn.cubeportfolio.constructor;/*
     * refreshGragLayout
     */
e["public"].refreshDragLayout=function(b,c){var d=e["private"].checkInstance.call(this,"refreshGragLayout"),f=d.blocks.eq(b),g=d.blocks.eq(c);if(b>c)g.before(f);else{if(!(c>b))return;g.after(f)}
// update blocks & index
d.blocks=d.$ul.children(".cbp-item"),d.blocks.each(function(b,c){a(c).data("cbp").index=b}),
// make layout
d.layout()}}(jQuery,window,document),
// RemoveActionContainer before destroy
function(a,b,c,d){"use strict";function e(b){var c=this;c.parent=b,b.registerEvent("publicMethod",function(){a.actionCBP.remove()})}var f=a.fn.cubeportfolio.constructor;e.prototype.destroy=function(){},f.plugins.removeActionContainer=function(a){
// if is frontend run this plugin
// if is frontend run this plugin
return"undefined"!=typeof cbpwOptions?new e(a):void 0}}(jQuery,window,document),// LoadMore public
function(a,b,c,d){function e(b){var c=this;c.parent=b,c.loadMore=a(b.options.loadMore).find(".cbp-l-loadMore-link"),
// load click or auto action
b.options.loadMoreAction.length&&c[b.options.loadMoreAction]()}var f=a.fn.cubeportfolio.constructor;e.prototype.click=function(){var b=this,c=0,d=parseInt(b.parent.options.displayItemsLoadMore,10);b.loadMore.on("click.cbp",function(e){var f=a(this);if(e.preventDefault(),!b.parent.isAnimating&&!f.hasClass("cbp-l-loadMore-stop")){f.addClass("cbp-l-loadMore-loading");var g=b.parent.wrapper.attr("id");g||(g=b.parent.$obj.attr("id")),g=g.replace("cbpw-grid",""),a.ajax({type:"post",dataType:"json",url:ajaxurl,data:{action:"getLoadMoreItems",offset:d*c,limit:d,id:g}}).done(function(a){c++;var d=a.items.map(function(a){return a.items}).join("");b.parent.$obj.cubeportfolio("append",d,function(){f.removeClass("cbp-l-loadMore-loading"),a.itemsRemain<=0&&f.addClass("cbp-l-loadMore-stop")})})}})},e.prototype.auto=function(){var c=this;c.parent.$obj.on("initComplete.cbp",function(){c.loadMoreObj=Object.create({init:function(){var d=this;
// the job inactive
// set loading status
// cache window selector
// add events for scroll
// trigger method on init
return d.isActive=!1,d.numberOfClicks=0,c.loadMore.addClass("cbp-l-loadMore-loading"),d.window=a(b),d.addEvents(),d.getNewItems(),this},addEvents:function(){var a,b=this;c.loadMore.on("click.cbp",function(a){a.preventDefault()}),b.window.on("scroll.loadMoreObject",function(){clearTimeout(a),a=setTimeout(function(){c.parent.isAnimating||
// get new items on scroll
b.getNewItems()},80)}),
// when the filter is completed
c.parent.$obj.on("filterComplete.cbp",function(){b.getNewItems()})},getNewItems:function(){var b,d,e=this;if(!(c.parent.isAnimating||e.isActive||c.loadMore.hasClass("cbp-l-loadMore-stop")||(b=c.loadMore.offset().top,d=e.window.scrollTop()+e.window.height(),b>d))){
// this job is now busy
e.isActive=!0;var f=parseInt(c.parent.options.displayItemsLoadMore,10),g=c.parent.wrapper.attr("id");g||(g=c.parent.$obj.attr("id")),g=g.replace("cbpw-grid",""),a.ajax({type:"post",dataType:"json",url:ajaxurl,data:{action:"getLoadMoreItems",offset:f*e.numberOfClicks,limit:f,id:g}}).done(function(a){var b=a.items.map(function(a){return a.items}).join("");c.parent.$obj.cubeportfolio("append",b,function(){
// increment number of clicks
e.numberOfClicks++,a.itemsRemain<=0?(c.loadMore.addClass("cbp-l-loadMore-stop").removeClass("cbp-l-loadMore-loading"),
// remove events
e.window.off("scroll.loadMoreObject"),c.parent.$obj.off("filterComplete.cbp")):(
// make the job inactive
e.isActive=!1,e.window.trigger("scroll.loadMoreObject"))})}).fail(function(){
// make the job inactive
e.isActive=!1})}}}).init()})},e.prototype.destroy=function(){var a=this;a.loadMore.off(".cbp"),a.loadMoreObj&&a.loadMoreObj.window.off("scroll.loadMoreObject")},f.plugins.loadMore=function(a){return""===a.options.loadMore?null:new e(a)}}(jQuery,window,document),
// FullWidthForce force
function(a,b,c,d){function e(b,d){var e=this;e.parent=b;var f=b.$obj.parent(),d=f.parent();d.hasClass("cbpw-fullWidth-force")&&b.registerEvent("beforeResizeGrid",function(){d.removeAttr("style"),d.css({width:a(c).width(),left:-f[0].getBoundingClientRect().left})})}var f=a.fn.cubeportfolio.constructor;e.prototype.destroy=function(){},f.plugins.fullWidthForce=function(a){return new e(a)}}(jQuery,window,document),
// init cubeportfolio
function(a,b,c,d){"use strict";var e=function(d,e){var f,g,h,i,j,k,l,m,n,o=a(c),p="",q="",r="",s=!0;
// get the selector
if(e=a(e),e.data("cbp-iswrap")===!1&&(s=!1),e.data("cbp-selector")){f=e.data("cbp-selector");
// remove scripts & css already in the popup
var t=a(".cbp-popup-wrap");t.find('script[type="text/javascript"]').remove(),t.find('link[type="text/css"], style').remove(),d=d.replace("<body",'<div data-cbpelement="body"').replace("</body>","</div>"),d=a("<div>",{html:d}),
// put the scrips in the newScripts array
j=[],g=d.find('script[type="text/javascript"]').remove();var u=[];o.find('script[type="text/javascript"]').each(function(b,c){c=a(c),c.html()&&u.push(c.html())});var v=/window\.devicePixelRatio/gim;for(i=0;i<g.length;i++)l=g[i].src,l?0===o.find('script[src="'+l+'"]').length&&j.push(g[i]):v.test(g[i].text)||-1===a.inArray(g[i].text,u)&&(r=r+";"+g[i].text);for(k=c.createElement("script"),k.type="text/javascript",k.text=b.vc_js?r+";window.vc_js();":r,j.push(k),h=d.find('link[type="text/css"], style').remove(),i=0;i<h.length;i++)m=h[i].href,m&&o.find('link[href="'+m+'"]').length||(q+=h[i].outerHTML);if("automatically"===f)p=d.find(".cbpw-ajax-block").first(),p.find(".cbpw-ajax-block").each(function(b,c){c=a(c),c.parent().append(c.html()),c.remove()}),p.parentsUntil('div[data-cbpelement="body"]').each(function(b,c){a(c).siblings().remove()}),p=d.find('div[data-cbpelement="body"]')[0].outerHTML;else if("manually"===f){for(n=["#main",'[role="main"]',"#main-content","#content","#Content",".main-content"],i=0;i<n.length;i++)if(p=d.find(n[i]),p.length){p=p[0].outerHTML;break}}else p="cbp-post"===f?d.find(".cbp-popup-singlePage > article").html():d.find(f)[0].outerHTML;d=p&&p.length?q+p:"Error! Please correct your wordpress link added to cubeportfolio singlePage popup!"}return{result:d,scripts:j,isWrap:s}},f=function(b,c){
// to update singlePage content use the following method: this.updateSinglePage(yourContent)
var d=this,f=b.match(/html-inline-\d+$/gi),g=b;f&&1===f.length&&(b=ajaxurl+"?link="+f[0]);var h=d.cubeportfolio.wrapper.attr("id");h||(h=d.cubeportfolio.$obj.attr("id")),h=h.replace("cbpw-grid",""),a.ajax({url:b,type:"POST",dataType:"html",timeout:3e4,data:{link:g,type:"cbp-singlePage",source:"cubeportfolio",id:h,selector:a(c).data("cbp-selector")}}).done(function(a){var b=e(a,c);d.updateSinglePage(b.result,b.scripts,b.isWrap)}).fail(function(){d.updateSinglePage("AJAX Error! Please refresh the page!")})},g=function(b,c){
// to update singlePage content use the following method: this.updateSinglePageInline(yourContent)
var d=this,f=b.match(/html-inline-\d+$/gi),g=b;f&&1===f.length&&(b=ajaxurl+"?link="+f[0]);var h=d.cubeportfolio.wrapper.attr("id");h||(h=d.cubeportfolio.$obj.attr("id")),h=h.replace("cbpw-grid",""),a.ajax({url:b,type:"POST",dataType:"html",timeout:3e4,data:{link:g,type:"cbp-singlePageInline",source:"cubeportfolio",id:h,selector:a(c).data("cbp-selector")}}).done(function(a){var b=e(a,c);d.updateSinglePageInline(b.result,b.scripts)}).fail(function(){d.updateSinglePageInline("Error! Please refresh the page!")})},h=function(b,c){"undefined"==typeof c.loadMore&&(c.loadMore="#cbpw-loadMore"+b),
// if (typeof options.filters === 'undefined') {
c.filters="#cbpw-filters"+b,
// }
/*********************************
             init cubeportfolio
             *********************************/
c.singlePageCallback=f,c.singlePageInlineCallback=g,a("#cbpw-grid"+b).cubeportfolio(c)};a(c).ready(function(){"undefined"!=typeof initCubePortfolio&&
// init cbp instances
a.each(initCubePortfolio,function(b,d){var e=a("#cbpw-wrap"+d.id),f=e.parent();f.hasClass("cbpw-fullWidth-force")&&f.css({width:a(c).width(),left:-e[0].getBoundingClientRect().left}),h(d.id,d.options)})})}(jQuery,window,document);